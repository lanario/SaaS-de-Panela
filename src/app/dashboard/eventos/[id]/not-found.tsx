...
export default function EventoNotFound() {
  return (
    <div className="text-center py-12">
      ...
      <Link
        href="/dashboard"
        className="inline-flex items-center justify-center rounded-xl bg-presentix-700 px-4 py-2 text-sm font-semibold text-white hover:bg-presentix-800 transition"
      >
        Voltar ao dashboard
      </Link>
    </div>
